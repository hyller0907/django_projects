...
# When you are using django generic views, you must tweak a little bit the urls.py
...
urlpatterns = [
    ...
    path('owner', views.owner, name='owner'),  # That is part of the coursera assignment
